...
export default function ProdectDetails() {
  return (
    <div className="box-border md:w-auto w-50 ml-60 border-2 border-gray-400 bg-white ">
      ...
      <div className="gmo flex gap-24 mb-1  text-sm text-left">
      ...
      <div className="max-w-md mx-auto text-justify" >This is made up products</div>
      ...
      <div className="max-w-md mx-auto text-left">It doesn't matters w</div>
      </div>
      <div className="gmo flex gap-24 mb-1  text-sm">
      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
      </svg>
      <div className="max-w-md mx-auto text-left ">Features description</div>
      </div>
      <div className="gmo flex gap-24 mb-1  text-sm">
      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
      </svg>
      <div className="max-w-md mx-auto text-left">This is made up products</div>
      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
      </svg>
      </div>
